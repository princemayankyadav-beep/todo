  ...
  return (
    <section className="w-full border-t border-stroke">
      <div className="mx-auto max-w-7xl px-12 py-24 flex items-center justify-center text-center">
        ...
        >
          "Computer Science student at Aryabhatta College, University of Delhi — building efficient software foundations while shaping refined web interfaces inspired by Apple-like clarity, high-performance dashboards, and cinematic UI systems."
        </motion.p>
      </div>
    </section>
  );
